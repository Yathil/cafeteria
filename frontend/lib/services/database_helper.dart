...
// // ======================
//   static Future<bool> createUser(UsuarioModel user) async {
...
//       return UsuarioModel.fromMap(results.first.fields);
//     } else {
//       return UsuarioModel.defaultValues();
//     }
//   }
...
// // ======================
//   static Future<bool> updateUser(UsuarioModel user) async {
//     final conn = await connect();
//     final results = await conn.query(
